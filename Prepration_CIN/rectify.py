...
Two methods are implemented to detect the edge of input CIN image:
...
def inference(input_path, output_path, trained_model, device):
    ...
    try:
        ...
        try:
            ...
            print("Failed. {} could not be rectified1 :(".format(os.path.basename(input_path)))
            sys.exit()
    ...
    try:
        ...
        print("Failed. {} could not be rectified2 :(".format(os.path.basename(input_path)))
        sys.exit()
    ...
    for i in range(0, len(file_list)):
        ...
        try:
            ...
            try:
                ...
                print("Failed. {} could not be rectified3 :(".format(file_list[i]))
                continue
        ...
        try:
            ...
            print("Failed. {} could not be rectified4 :(".format(file_list[i]))
